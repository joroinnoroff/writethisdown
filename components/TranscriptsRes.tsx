    ...
    <div className='h-full bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-gray-700 p-6'>
      <div className='flex items-center justify-between mb-6'>
        <div className='flex items-center gap-3'>
          <FileText className='w-5 h-5 text-indigo-600 dark:text-indigo-400 d' />
        ...
        <button
          onClick={handleCopy}
          className='flex items-center gap-2 px-3 py-2 text-sm text-gray-600 dark:gray-600 rounded-lg transition-all hover:bg-grey-100 dark:hover:bg-gray-700'>
